...
type Store interface {
	...
	PruneMLRuns(ctx context.Context, orgID, actorID string, in []RunPruneInput) (int, error)
	PruneMLModelVersions(ctx context.Context, orgID, actorID string, in VersionPruneInput) (int, error)
