...
func New(s store.Store, bearer authmw.BearerVerifier, cfg *config.Config, st storage.Client, c cache.Client) http.Handler {
	...
	protected("GET", "/api/v1/orgs/{orgID}/diagrams/{diagramID}/thumbnail", diagramH.GetThumbnail)
	...
	protected("GET", "/api/v1/orgs/{orgID}/diagrams/{diagramID}/images/{fileID}", diagramH.GetImage)
	...
	protected("GET", "/api/v1/orgs/{orgID}/frames/{frameID}/screenshot", frameH.GetScreenshot) // streams screenshot image
